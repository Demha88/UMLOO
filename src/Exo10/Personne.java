...
public abstract class Personne {
    ...
    public static void afficherNbPersonnes(){
        System.out.println("Il y a " + nbPersonnes + " personne" + ((nbPersonnes > 1)? "s":""));
    }
    public void afficherAge(){
        LocalDate today = LocalDate.now();
        Period period = Period.between(this.dateNaissance, today);
        System.out.println("J'ai "+period.getYears() + " an"+((period.getYears()>1)?"s":""));
    }
